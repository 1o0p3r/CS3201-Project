...
public:
	...
	TEST_METHOD(SampleSouce6) {
		...
		vector<string> answer;
		vector<string> queries = {
			"procedure p1; Select p1 such that Calls*(p1, _)",
	...
	TEST_METHOD(Sample_Source_7) {
		...
		vector<vector<string>> expected = {
			...
			{ "119 102 105","119 46 50","120 102 105","120 46 50","122 102 105","122 46 50",
				...
				"143 102 105", "143 46 50", "16 102 105","16 46 50","18 102 105","18 46 50","22 102 105",
				"22 46 50","6 102 105","6 46 50","64 102 105","64 46 50","66 102 105","66 46 50","99 102 105","99 46 50"
			}
		};
		validator = QueryValidator(); //re-init validator.
		for (int i = 0; i < queries.size(); i++) {
